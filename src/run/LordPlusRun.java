...
/**
 * Cross-validation benchmark for multi-thread LORD-Plus algorithm
...
public class LordPlusRun {
	...
	public static void main(String[] args) throws Exception {
        ...
        if(arguments.output_directory == null && arguments.input_directory != null){
        	...
        	arguments.output_directory = Paths.get("data/outputs/lordplus_cv", simple_dir_name).toString();
        }
        ...
        System.out.println("Running LORD-Plus ...");
