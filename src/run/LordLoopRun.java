...
/**
 * Cross-validation benchmark LORDLoop, a variant of LORD
...
public class LordLoopRun {
	...
	public static void main(String[] args) throws Exception {
        ...
        if(arguments.output_directory == null && arguments.input_directory != null){
        	...
        	arguments.output_directory = Paths.get("data/outputs/lordloop_cv/", simple_dir_name).toString();
        }
        ...
        System.out.println("Running LORDLoop (Eager & Greedy) ...");
