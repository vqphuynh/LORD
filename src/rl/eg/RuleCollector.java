...
//    }
	...
	public RuleCollector(int default_class_id, Map<String, RuleInfo> rule_set){
	...
	public RuleCollector(int default_class_id, Map<String, RuleInfo> rule_set, int[][] selectorID_records){
		this.defaultClassID = default_class_id;
	...
	public RuleCollector(int default_class_id,
