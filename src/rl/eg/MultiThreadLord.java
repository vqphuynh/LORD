 ...
 */
public class MultiThreadLord extends RuleLearner {
     ...
     */
    public MultiThreadLord(int target_attr_count) throws FileNotFoundException {
     ...
     * @throws FileNotFoundException
     */
    public MultiThreadLord(int thread_count, int target_attr_count) throws FileNotFoundException {
    ...
    public long learning(METRIC_TYPES metric_type, double arg){
		...
		this.classifier = new Classifier(this.default_classID, ruleSet_list, this.selectorID_records, this.thread_count);
